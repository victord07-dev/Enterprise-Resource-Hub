...
export const attendanceRecords = pgTable("attendance_records", {
  ...
  fieldVisitOut: timestamp("field_visit_out"),
  fieldVisitIn: timestamp("field_visit_in"),
...
export const customerTypeValues = ["vendor", "solar_consumer", "customer", "end_user", "business"] as const;
...
export const vehicleFuelLogs = pgTable("vehicle_fuel_logs", {
  ...
  postedToAccounts: boolean("posted_to_accounts").notNull().default(false),
